...
<head>
    ...
    <title>Leter.io - @yield('title', 'Secure sensitive information disclosure system for whistleblowers.')</title>
                    ...
                    @else
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="/settings"><i class="fa fa-btn fa-fw fa-cog"></i>Your Settings</a></li>
                                <li class="divider"></li>
